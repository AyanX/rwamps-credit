...
const productsTable= mysqlTable("products", {
  ...
  text_color: varchar("text_color", { length: 255 }),
...
const testimoniesTable = mysqlTable("testimonies", {
 ...
 text_color: varchar("text_color", { length: 255 }),
 loan_purpose_text_color: varchar("loan_purpose_text_color", { length: 255 }),
 initials_bg_color: varchar("initials_bg_color", { length: 255 }),
  isDeleted: boolean("isDeleted").default(false),
  created_at: timestamp("created_at").defaultNow(),
  updated_at: timestamp("updated_at").defaultNow().onUpdateNow(),
})
